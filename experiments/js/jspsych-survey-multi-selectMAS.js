...
jsPsych.plugins['survey-multi-selectMAS'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    for (var i = 0; i < trial.questions.length; i++) {
      ...
      // add question text
      display_element.querySelector(question_selector).innerHTML += '<p id="survey-question" class="' + plugin_id_name + '-text survey-multi-select" style="margin-left:15px;margin-right:10px;color:black">' + question.prompt + '</p>';
      ...
      for (var j = 0; j < question.options.length; j++) {
        ...
        display_element.querySelector(question_selector).innerHTML += '<div id="'+option_id_name+'" class="'+_join(plugin_id_name, 'option')+'" style="color:black"></div>';
